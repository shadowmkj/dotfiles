                ...
                actions = {
                    ...
                    ["ctrl-l"] = {
                        ...
                        fn = function(selected, opts)
                            fzf.actions.file_sel_to_ll(selected, opts)
                            vim.cmd("lclose") -- Force the standard loclist window to shut
                    ...
                    ["ctrl-q"] = {
                        ...
                        fn = function(selected, opts)
                            ...
                            vim.cmd("cclose") -- close default quickfix window
